...
package vistas.componentes.TextFields;
...
public class PasswordField extends JPasswordField{
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/vistas/componentes/TextFields/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/vistas/componentes/TextFields/eye_hide.png")).getImage();
